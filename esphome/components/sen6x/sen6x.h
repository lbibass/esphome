...
class SEN6XComponent : public PollingComponent, public sensirion_common::SensirionI2CDevice {
 public:
  ...
  enum Sen6xType { SEN60, SEN63C, SEN65, SEN66, SEN68, UNKNOWN };
  ...
  // void set_auto_cleaning_interval(uint32_t auto_cleaning_interval) { auto_cleaning_interval_ =
  // auto_cleaning_interval; } // SEN6X does not support auto cleaning interval
